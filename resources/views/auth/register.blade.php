...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('store') }}" method="post" id="register-user">
                    @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password">
                            ...
                            <h6 id="passcheck" style="color: red;">Please Fill the password</h6>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          ...
                          <h6 id="conpasscheck" style="color: red;">Password didn't match</h6>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <input type="submit" id="submitbtn" class="col-md-3 offset-md-5 btn btn-primary" value="Register">
                    </div>
